...
#Write a function
best <- function(state_abbr="PA",outcome = "heart attack")
{
    #Read Outcome Data
    outcome_data <- read.csv(file = "outcome-of-care-measures.csv")
    
    #Check that State and Outcome are valid
    data(state)  #load state data to get list of state abbreviations
    ...
    outcome_data_filtered <- outcome_data[outcome_data$State == state_abbr,]
